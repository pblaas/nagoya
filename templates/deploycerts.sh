...
declare -a pkilist
pkilist=($1"-k8s-kube-cm.pem"
         $1"-k8s-kube-proxy-key.pem"
         $1"-k8s-kube-proxy-key.pem"
         $1"-k8s-kube-proxy.pem"
         $1"-k8s-kube-scheduler-key.pem"
         $1"-k8s-kube-scheduler.pem"
         $1"-k8s-kubelet-client-key.pem"
         $1"-k8s-kubelet-client.pem"
         $1"-k8s-node-key.pem"
         $1"-k8s-node.pem"
